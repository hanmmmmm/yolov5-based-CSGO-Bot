...
def get_gpu_state():
    ...
    # print( gpu.id )
    # print( gpu.name )
    # print( int(gpu.load*100) )
    # print( int(gpu.temperature) )
    # print( int(gpu.memoryTotal) )
    # print( int(gpu.memoryUsed) )
    
    return gpu.id, gpu.name, int(gpu.load*100), int(gpu.temperature), int(gpu.memoryTotal), int(gpu.memoryUsed)    
